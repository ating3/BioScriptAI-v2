...
const SOURCE_CONFIG = {
  ...
  arxiv: { label: 'arXiv', color: '#1D4ED8', icon: Atom },
  nature: { label: 'Nature', color: '#1D4ED8', icon: Leaf },
  science: { label: 'Science', color: '#2563EB', icon: Brain },
  cell: { label: 'Cell', color: '#2563EB', icon: Dna },
  biorxiv: { label: 'bioRxiv', color: '#2563EB', icon: Dna },
  medrxiv: { label: 'medRxiv', color: '#2563EB', icon: Microscope },
  ...
  if (summary?.error) {
    return (
      <div className="flex items-start gap-2 p-3 rounded-lg" style={{ background: '#EFF6FF', border: '1px solid #BFDBFE' }}>
        <AlertCircle size={13} style={{ color: '#1D4ED8', marginTop: 1 }} />
        <p className="text-xs" style={{ color: '#1D4ED8' }}>{summary.error}</p>
      </div>
    )
  }
        ...
        <div key={type}>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button
              ...
              style={{
                background: copied === type ? '#EFF6FF' : isDark ? '#1F2937' : '#F3F4F6',
                color: copied === type ? '#1D4ED8' : '#6B7280',
              }}
            >
        ...
        <div className="p-4 space-y-4">
          ...
          >
            <div className="flex items-start gap-3">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #EFF6FF, #EFF6FF)' }}
              >
          ...
          >
            ...
            <div className="space-y-2">
              {[
                { step: '1', text: 'Open any paper from an academic database.' },
